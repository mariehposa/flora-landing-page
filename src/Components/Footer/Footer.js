	...
	return(
		<div className="bg-washed-blue">	
	      <footer className="pa4 pa5-l black-70 bt b--black-10">
			    ...
			    <div className="mb2 mb0-ns w-100 w-50-l fl">
			      <a className="black-70 f3 f2-ns fw6 tl link dim dib pv3 mt2 mb0-l" href="floura@gmail.com" >
			        floura@gmail.com
			      </a>
			    </div>
			   </section>
			   <div className="cf">
			    <article className="fl w-50 dib-ns w-auto-ns mr4-m mr3-l mb4 pr2 pr0-ns">
			      <a href="/About/" className="f5 f5-l">About</a>
			    </article>
			    <article className="fl w-50 dib-ns w-auto-ns mr4-m mr3-l mb4 pl2 pl0-ns">
			      <a href="/contact/" className="f5 f5-l">Contact</a>
			    </article>
			    <article className="fl w-50 dib-ns w-auto-ns mr4-m mr3-l mb4 pr2 pr0-ns">
			      <a href="/terms of use/" className="f5 f5-l">Terms of use</a>
			    </article>
			    <article className="fl w-50 dib-ns w-auto-ns mb4 pl2 pl0-ns">
			      <a href="/privacy policy/" className="f5 f5-l">Privacy policy</a>
			    </article>
			   </div>
			   <div className="dt dt--fixed w-100" >
				   <div className="dn dtc-ns v-mid">
				      <p className="f7 black-70 dib pr3 mb3">© Floura Website 2018. All Rights Reserved.</p>
				   </div>
			   ...
			   <div className="db dn-ns">
				   <p className="f7 black-70 mt4 tc">© Floura Website 2018. All Rights Reserved.</p>
			   </div>
			</footer>
		</div>
	);
